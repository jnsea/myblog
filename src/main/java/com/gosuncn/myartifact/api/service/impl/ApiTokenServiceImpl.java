...
import com.gosuncn.myartifact.api.dao.ApiTokenDao;
...
public class ApiTokenServiceImpl extends ServiceImpl<ApiTokenDao, ApiTokenEntity> implements ApiTokenService {
	/**
	 * 12小时后过期
	 */
	...
	public ApiTokenEntity queryByToken(String token) {
		return this.selectOne(new EntityWrapper<ApiTokenEntity>().eq("token", token));
	}
